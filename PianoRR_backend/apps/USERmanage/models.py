...
class User(models.Model):
    ...
    person_id = models.CharField(u'学号/工作证号/手机号', max_length=32, unique=True, db_index=True)
...
class ArtTroupeMember(models.Model):
    student_id = models.CharField(u'学号', max_length=32, unique=True, db_index=True)
    name = models.CharField(u'姓名', max_length=12)
...
class BlackList(models.Model):
    person_id = models.ForeignKey(User,to_field='person_id',  on_delete=models.CASCADE, verbose_name='用户')
    name = models.CharField(u'姓名', max_length=12, blank=True)
    group = models.ForeignKey(UserGroup, on_delete=models.CASCADE, verbose_name='用户组', default=None)
    reason = models.TextField(u'拉黑理由')
