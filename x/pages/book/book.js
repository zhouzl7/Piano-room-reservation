...
Page({
  ...
  data: {
    time: [
      ...
      {
        id: 1, timestr: "9:00-10:00", color: "transparent"
      },
      {
        id: 2, timestr: "10:00-11:00", color: "transparent"
      },
      {
        id: 3, timestr: "13:00-14:00", color: "transparent"
      },
      {
        id: 4, timestr: "14:00-15:00", color: "transparent"
      },
      {
        id: 5, timestr: "15:00-16:00", color: "transparent"
      }
    ],
    Days: [
      {
  ...
  onShow: function () {
    ...
    for(let i = 0;i < length;i++){
      if (this.data.Days[chosenDay].room[chosenRoom].disabled[i]){
        this.data.time[i].color = "transparent"
      }else{
  ...
  chooseDay: function(event){
    ...
    this.data.Days[chosenDay].color = "transparent"
    this.data.Days[chosenDay].room[chosenRoom].color = "transparent"
  ...
  chooseTime: function(event) {
    ...
    if (this.data.Days[chosenDay].room[chosenRoom].chosen[index] === false){
      ...
      this.data.time[index].color = "transParent"
